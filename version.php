...
$plugin->version   = 2012071200; // The current module version (Date: YYYYMMDDXX)
...
$plugin->release = '1.1 (Build: 2012071200)';
$plugin->component = 'theme_unitec_corporate'; // Full name of the plugin (used for diagnostics)
